...
st.set_page_config(
    page_title="Bullet Inferno Roguelike v5",
    layout="centered",
...
runStats = {zone:1,bossesKilled:0,coins:0,score:0,bombs:{blue:0,purple:0,gold:0},hearts:0,revives:0,seed:0,activeTime:0,victory:false,secretTrial:false};
