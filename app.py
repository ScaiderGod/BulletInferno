...
function practiceGameOver() {
    // Keep the current boss music playing on Game Over until the player chooses where to go.
    state = 'ended';
    showOverlay(`
        <div class="card">
...
function permanentGameOver() {
    ...
    // Keep the current boss music playing on the final Game Over screen until the player chooses a destination.
    state = 'ended';
    addBoardEntry({
        name: playerName,
        victory: false,
...
function showGameOver() {
    ...
    // Do not stop boss music here. It should keep looping while the player decides to revive or end the run.
    state = 'gameover';
...
function startDeathSequence() {
    ...
    player.dead = true;
    player.invuln = 99;
    // Boss music intentionally continues through the destruction and Game Over decision screens.
    playSfx('destroy');
    screenFlash = 0.95;
    screenShake = 1.25;
